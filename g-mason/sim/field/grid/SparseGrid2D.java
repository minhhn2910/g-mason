...
public class SparseGrid2D extends SparseField implements Grid2D, SparseField2D
    ...
    */
    ...
    public Double2D getObjectLocationAsDouble2D(Object obj)
        {
        Int2D loc = ((AgentInt)obj).getLocation();
 ...
 //just keep this, not supported on CPU side
    ...
    public boolean InitObjectLocation(final Object obj, final int x, final int y)
        {
   ...
   public boolean setObjectLocation(Object obj, final int x, final int y)
        {
			Int2D location = new Int2D(x,y);
			((AgentInt)obj).setLocation(location);
			return true;// super.setObjectLocation(obj, location);
        }
