 ...
 */
   ...
   public final Double2D getObjectLocation(Object obj)
        {
			return  ((AgentDouble)obj).getLocation();
        }
...
/** initObjectLocation is the original setObjectLocation of Mason, we keep this for init location and Bag of all object, not loose the data structure of mason
 * */    
    public boolean initObjectLocation(Object obj, final Double2D location)
        {
    ...
    public boolean setObjectLocation(Object obj, final Double2D location)
        {
			((AgentDouble)obj).setLocation(location);
    ...
    */
    ...
    /** Returns a Bag containing EXACTLY those objects within a certain distance of a given position.  If 'radial' is true,
        ...
        to within the boundaries before computation.
    */
//implement in cuda, toroidal= true, radial = true, inclusive = true
    public Bag getNeighborsExactlyWithinDistance(final Double2D position, final double distance, final boolean toroidal, 
        final boolean radial, final boolean inclusive, Bag result)
        {
