...
public class ValuePortrayal2D extends RectanglePortrayal2D
    ...
    public static class DoubleFilter extends Filter
        ...
        public double getValue() { return ((DoubleGrid2D)fieldPortrayal.getField()).get(x,y); }
        public void setValue(double val) { ((DoubleGrid2D)fieldPortrayal.getField()).set(x,y,fieldPortrayal.newValue(x,y,val)); }
