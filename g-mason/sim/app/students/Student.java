...
public class Student extends AgentDouble
    {
 ...
 public double getAgitation() { return students.agitation.get(index); }


	@Override
	public Double2D getLocation()
	{
		return new Double2D(students.location.get(index*2),students.location.get(index*2+1));
	}
	
	@Override
	public void setLocation(Double2D location)
	{
		//~ students.loc_x[index] = location.x;
		//~ students.loc_y[index] = location.y;
		
		students.location.put(index*2,location.x);
		students.location.put(index*2+1,location.y);
